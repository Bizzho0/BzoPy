...
cfg.InteractiveShell.editor = os.environ.get("SUBLIMEREPL_EDITOR", editor)# hoooo!!!
...
if os.name == "nt":
    # OMG what a fugly hack, fugly hack!!??  hahahahah
    ...
    embedded_shell.shell.show_banner()  # ... my eyes, oh my eyes.. hahahahahahaha
